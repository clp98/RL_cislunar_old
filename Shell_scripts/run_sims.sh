...
python main_solve_RL_auto.py --config "config_files/moon_station_keeping_config.yaml"  #4 body, error i.c., max_dist_r, clip=0.05, lr=0.0001 cost, epsilon=(0.1,0.001), MLP
python main_solve_RL_auto.py --config "config_files/moon_station_keeping_config_2.yaml"  #4 body, error i.c., max_dist_r, clip=0.05, lr=0.0001 cost, epsilon=(0.1,0.001), LSTM
