...
replot for [k = 1:120:5] filename2 i k using 1:2:3 w l lt 6 lw 2.5 notitle "$Ly_1$" #0:40:1
...
# replot filename2 every ::400 using 1:2 w p ls 2 notitle "Departure"
