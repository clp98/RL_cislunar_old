...
replot for [k = 13+Ly1:13+Ly1] filename1 i k using 1:2 w l lt 6 lw 2 notitle "L1 Lyapunov orbit" #0:40:1
replot for [k = 18+Ly2:18+Ly2] filename2 i k using 1:2 w l lt 7 lw 2 notitle "L2 Lyapunov orbit" #0:40:1 #18 #21
#replot filename4 using 2:3 w l lt 4 lw 2 title "GPOPS"
replot filename4 using 2:3 w l lt 12 lw 1 title "MC samples"
replot filename3 using 2:3 w l lt 8 lw 2 title "Nominal"
